        ...
        <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
            <form action="{{ route('activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $activity->name) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    @error('name') <p class="text-red-500 text-xs italic">{{ $message }}</p> @enderror
                </div>

                <div class="mb-4">
                    <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Descrição</label>
                    <textarea name="description" id="description" rows="3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $activity->description) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <select name="type" id="type" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        <option value="palestra" {{ old('type', $activity->type) == 'palestra' ? 'selected' : '' }}>Palestra</option>
                        <option value="minicurso" {{ old('type', $activity->type) == 'minicurso' ? 'selected' : '' }}>Minicurso</option>
                        <option value="workshop" {{ old('type', $activity->type) == 'workshop' ? 'selected' : '' }}>Workshop</option>
                        <option value="painel" {{ old('type', $activity->type) == 'painel' ? 'selected' : '' }}>Painel</option>
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <select name="instructor_id" id="instructor_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        @foreach($instructors as $instructor)
                            <option value="{{ $instructor->id }}" {{ old('instructor_id', $activity->instructor_id) == $instructor->id ? 'selected' : '' }}>
                ...
                <div class="mb-4">
                    ...
                    <select name="event_id" id="event_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        @foreach($events as $event)
                            <option value="{{ $event->id }}" {{ old('event_id', $activity->event_id) == $event->id ? 'selected' : '' }}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="datetime-local" name="start_time" id="start_time" value="{{ old('start_time', $activity->start_time->format('Y-m-d\TH:i')) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="end_time" id="end_time" value="{{ old('end_time', $activity->end_time->format('Y-m-d\TH:i')) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="number" name="workload_hours" id="workload_hours" value="{{ old('workload_hours', $activity->workload_hours) }}" min="1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="total_spots" id="total_spots" value="{{ old('total_spots', $activity->total_spots) }}" min="1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                ...
                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="has_cost" value="1" {{ old('has_cost', $activity->has_cost) ? 'checked' : '' }} class="mr-2">
                ...
                <div class="mb-4" id="pix_key_container" style="display: none;">
                    ...
                    <input type="text" name="pix_key" id="pix_key" value="{{ old('pix_key', $activity->pix_key) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    @error('pix_key') <p class="text-red-500 text-xs italic">{{ $message }}</p> @enderror
                </div>

                <div class="mb-4">
                    <label class="flex items-center">
                        <input type="checkbox" name="waiting_list_enabled" value="1" {{ old('waiting_list_enabled', $activity->waiting_list_enabled) ? 'checked' : '' }} class="mr-2">
