...
<head>
    ...
    <title>Inscrições em Atividades - GESTEC</title>
    @vite('resources/css/app.css')
</head>
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center mb-8">Inscrições em Atividades</h1>
        ...
        <div class="mb-4">
            <a href="{{ route('enrollments.my-enrollments') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Minhas Inscrições
            </a>
        </div>
